...
The first "find file" in a large or remote project has to index it, and
that indexing runs synchronously - Emacs is blocked until it finishes. You
can warm the cache ahead of time, without blocking, using kbd:[M-x]
