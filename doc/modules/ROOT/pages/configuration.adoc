...
`fido-mode`/`icomplete`, Ido's `ido-ubiquitous`, and so on. Its candidates are
tagged with the `project-file` completion category, which Marginalia and Embark
use to enhance how they're presented.
