...
* `projectile-indexing-method` - leave at the default (`hybrid`) or set
  to `alien`.  *Don't* use `native` over TRAMP: native indexing walks
...
xref:migrating_to_projectile_3.adoc#_ido_users[migration guide] for details.
