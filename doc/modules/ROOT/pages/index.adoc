...
Here's a glimpse of Projectile in action (using `vertico` and `marginalia` for
minibuffer completion):

image::projectile-demo.gif["A tour of Projectile: finding a file, toggling to its implementation, a reviewed project-wide replace, the project's tasks, the dashboard and doctor reports, and a switch to another project"]
...
TIP: The strip across the top of the frame shows the keybindings used in the
demo and the commands that they invoked.footnote:[Courtesy of
https://metaredux.com/posts/2019/12/07/dead-simple-emacs-screencasts.html[keycast].]
